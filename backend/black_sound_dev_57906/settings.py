"""
Django settings for black_sound_dev_57906 project.
...
ROOT_URLCONF = 'black_sound_dev_57906.urls'
...
WSGI_APPLICATION = 'black_sound_dev_57906.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "black_sound_dev_57906 API",
    "DESCRIPTION": "API documentation for black_sound_dev_57906 App",
    "VERSION": "v1",
}
